<div class="bg-white rounded-3xl px-[45px] py-[50px] w-96">
    ...
    <form action="" method="POST">
        ...
        <div class="relative mb-4">
            <input id="username" name="username" type="text" placeholder="Username" class="w-full px-4 py-3 rounded-xl bg-slate-100 focus:outline-none focus:ring-2 focus:border-blue-500">
            <?= form_error('username', '<span class="text-red-500 text-[12px] font-medium my-1">', '</span>') ?>
        </div>

        <!--Password-->
        <div class="relative mb-8">
            <input id="password" name="password" type="password" placeholder="Password" class="w-full px-4 py-3 rounded-xl bg-slate-100 focus:outline-none focus:ring-2 focus:border-blue-500">
